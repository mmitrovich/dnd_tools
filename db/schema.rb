...
ActiveRecord::Schema.define(version: 20170528003101) do
  ...
  create_table "spell_books_and_spells", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "spell_book_id", null: false
    t.integer "spell_id", null: false
    t.index ["spell_book_id"], name: "index_spell_books_and_spells_on_spell_book_id"
    t.index ["spell_id"], name: "index_spell_books_and_spells_on_spell_id"
  end
